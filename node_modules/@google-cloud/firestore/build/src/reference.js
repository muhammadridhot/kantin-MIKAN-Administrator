...
class QueryOptions {
    ...
    static forCollectionQuery(collectionRef) {
        return new QueryOptions(collectionRef.parent(), collectionRef.id, /*allDescendants=*/ false, 
...
class Query {
    ...
    where(fieldPath, opStr, value) {
        ...
        const options = this._queryOptions.with({ fieldFilters: this._queryOptions.fieldFilters.concat(fieldFilter) });
    ...
    orderBy(fieldPath, directionStr) {
        ...
        const options = this._queryOptions.with({ fieldOrders: this._queryOptions.fieldOrders.concat(newOrder) });
        return new Query(this._firestore, options);
    }
    /**
